  ...
  return (
    <div className="min-h-screen bg-lightbg dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <div className='flex flex-col items-end justify-end gap-2 border-t-2 border-[#243d52] p-8 bg-[#1b1e47a9]'>
        ...
        <p onClick={() => window.location.href = 'https://persona-flow-git-transition-nikunj-agarwals-projects.vercel.app/'} className='text-white text-2xl border-2 border-white px-4 py-2 cursor-pointer rounded-2xl bg-[#2a4668] hover:bg-[#5d1c1c]'>Go to page</p>
      </div>
    </div>
  );
};
